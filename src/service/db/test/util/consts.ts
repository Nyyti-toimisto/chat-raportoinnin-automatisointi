...
export const doArraysIntersect = <T extends Array<T[0]>>(array1: T, array2: T): boolean =>
...
export const feedbackMockData = (queues: NinQueue['queue_transcripts']) => {
    ...
    const sourceOfReference = createEvenlyRepeatedArray(
        ['Oppilaitos/opiskelijajärjestö', 'Kaveri', 'Sosiaalinen media', 'Muu'],
        queues.length / 2 / 4
    );
