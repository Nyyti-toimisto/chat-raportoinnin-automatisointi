        ...
        return (
            <>
                <div className={styles.headerBar}>
                    ...
                    <InfoBoxS title="Jälkipalautteita" value={records.post_feedback_count} />
                </div>
                <AnimatedHorizLine />
                <div className={styles.footer}>
                    <TableComponent
                        date={
                            records.latest_post_feedback > records.latest_pre_feedback
                                ? records.latest_post_feedback
                                : records.latest_pre_feedback
                        }
                    />
                    <TableDivider />
                    <TableComponent
                        date={
                            records.oldest_post_feedback < records.oldest_pre_feedback
                                ? records.oldest_post_feedback
                                : records.oldest_pre_feedback
                        }
                    />
                </div>
            </>
